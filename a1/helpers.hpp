...
struct SequenceInfo {
    ...
    unsigned long gpsa_taskloop(float** s, float** SUB, std::unordered_map<char, int> cmap, int grain_size);
    unsigned long gpsa_tasks(float** s, float** SUB, std::unordered_map<char, int> cmap, int grain_size);
